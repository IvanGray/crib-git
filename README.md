...
5. GIT Ветление
 ...
 + [Перезапись изменений / фиксация ошибок](#merge---слияние-веток);
 + [Конфликты](#Конфликты);
6. Работа с удаленными репозиториями
 + [GIT хостинг](#Работа-с-удаленными-репозиториями);
 + [Origin](#origin);
 + [Получение и отправка файлов на удаленный гит репозиторий](#origin);
